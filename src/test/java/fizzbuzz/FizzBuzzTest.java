...
public class FizzBuzzTest {
	...
	Assert.assertTrue("Should have responded 1", response.equals("1"));
	
	}
	
	@Test
	public void shouldSay2WithAssertsEquals() {
	...
	@Test
	public void shouldSay4() {
		String response = underTest.say(4);
		assertThat(response, is("4"));
		assertThat("Should have responded 4", response, is("4"));
	}
	@Test
	public void shouldsayFizz6() {
